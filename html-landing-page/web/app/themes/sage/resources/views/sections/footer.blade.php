    ...
    <div class="container px-4">
      <div class="row gy-10">
        ...
        <div class="sm:col-4 md:col-3 md:offset-3 xl:col-2 xl:offset-6">
          @if ($footer_col_1)
            <ul class="space-y-2">
              @foreach ($footer_col_1 as $item)
                <li><a class="block text-emperor font-bold hover:text-white transition-colors" href="{{ $item->url }}">{{ $item->label }}</a></li>
              @endforeach
            </ul>
          @endif
        </div>
