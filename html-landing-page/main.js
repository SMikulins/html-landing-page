...
document.querySelector( '#app' ).innerHTML = `
  <div>
    ...
    <section class="relative flex flex-col pt-[4.5rem] ">
      <img class="absolute inset-0 object-cover h-full w-full" src="${bgImage}" alt="">
      
      <div class="relative py-32">
        <div class="container">
        
          <div class="offset-7 col-5">
            <h1 class="text-6xl font-bold">Let's Go!</h1>
            <div class="space-y-5 mt-6">
              <p class="font-bold">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse dictum efficitur justo imperdiet pulvinar. Phasellus leo purus</p>
            ...
            <a class="inline-block text-hollywood-cerise font-bold border-2 border-hollywood-cerise rounded-full py-3 px-8 mt-14 hover:text-white hover:bg-hollywood-cerise transition-colors" href="#">Call to Action</a>
